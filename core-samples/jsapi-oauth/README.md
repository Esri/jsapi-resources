# Accessing ArcGIS Online using OAuth 2.0 with ESM + Vite (Deprecated)
...
📁 **[Click here to download this directory as a ZIP file](https://esri.github.io/jsapi-resources/zips/jsapi-oauth.zip)** 📁
