# ArcGIS Maps SDK for JavaScript with Angular CLI (Deprecated)
...
📁 **[Click here to download this directory as a ZIP file](https://esri.github.io/jsapi-resources/zips/jsapi-angular-cli.zip)** 📁
