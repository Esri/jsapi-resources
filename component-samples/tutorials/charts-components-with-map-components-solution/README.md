# Charts components with Map components - (solution)

📁 **[Click here to download this directory as a ZIP file](https://esri.github.io/jsapi-resources/zips/charts-components-with-map-components-solution.zip)** 📁
